...
\begin{itemize}
  ...
  \item Perform callsign lookups and auto-fill data fields using the \texttt{qrz.com} database.
...
While PyQSO can read and write ADIF files, please note that only a subset of all ADIF fields are supported.
